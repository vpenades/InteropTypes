...
namespace InteropTypes.Graphics.Backends
{
    partial class ImageSharpToolkit
    {
        ...
        public static TResult ReadAsSpanBitmap<TResult>(this Image<A8> self, SpanBitmap<Pixel.Alpha8>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.Alpha8, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<L8> self, SpanBitmap<Pixel.Luminance8>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.Luminance8, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<L16> self, SpanBitmap<Pixel.Luminance16>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.Luminance16, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Bgr24> self, SpanBitmap<Pixel.BGR24>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.BGR24, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Rgb24> self, SpanBitmap<Pixel.RGB24>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.RGB24, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Bgra32> self, SpanBitmap<Pixel.BGRA32>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.BGRA32, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Rgba32> self, SpanBitmap<Pixel.RGBA32>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.RGBA32, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Argb32> self, SpanBitmap<Pixel.ARGB32>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.ARGB32, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<RgbaVector> self, SpanBitmap<Pixel.RGBA128F>.Function1<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.RGBA128F, TResult>(self,default, (a,b) => function(a) ); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<A8> self, SpanBitmap<Pixel.Alpha8> other, SpanBitmap<Pixel.Alpha8>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.Alpha8, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<L8> self, SpanBitmap<Pixel.Luminance8> other, SpanBitmap<Pixel.Luminance8>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.Luminance8, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<L16> self, SpanBitmap<Pixel.Luminance16> other, SpanBitmap<Pixel.Luminance16>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.Luminance16, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Bgr24> self, SpanBitmap<Pixel.BGR24> other, SpanBitmap<Pixel.BGR24>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.BGR24, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Rgb24> self, SpanBitmap<Pixel.RGB24> other, SpanBitmap<Pixel.RGB24>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.RGB24, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Bgra32> self, SpanBitmap<Pixel.BGRA32> other, SpanBitmap<Pixel.BGRA32>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.BGRA32, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Rgba32> self, SpanBitmap<Pixel.RGBA32> other, SpanBitmap<Pixel.RGBA32>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.RGBA32, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<Argb32> self, SpanBitmap<Pixel.ARGB32> other, SpanBitmap<Pixel.ARGB32>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.ARGB32, TResult>(self, other, function); }
        public static TResult ReadAsSpanBitmap<TResult>(this Image<RgbaVector> self, SpanBitmap<Pixel.RGBA128F> other, SpanBitmap<Pixel.RGBA128F>.Function2<TResult> function) { return _Implementation.ReadAsSpanBitmap<Pixel.RGBA128F, TResult>(self, other, function); }
