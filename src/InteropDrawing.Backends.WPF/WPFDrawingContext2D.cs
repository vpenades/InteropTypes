...
namespace InteropDrawing.Backends
{
    ...
    /// </summary>
    public class WPFDrawingContext2D : System.Windows.Threading.DispatcherObject, IDrawing2D
    {
        #region lifecycle
        ...
        public void DrawScene(Size? viewport, Matrix3x2 prj, Matrix3x2 cam, Model2D scene)
        {
            this.VerifyAccess();
            this.VerifyContext();
            ...
            scene.DrawTo((this, w, h), prj, cam);
            PopClipRect(viewport);
        }

        public void DrawScene(Size? viewport, Matrix4x4 prj, Matrix4x4 cam, Model3D scene)
        {
            this.VerifyAccess();
            this.VerifyContext();
            ...
            PushClipRect(viewport);
            scene.DrawTo((this, w, h), cam, prj);
            PopClipRect(viewport);
        }

        public void DrawScene(Size? viewport, ISceneViewport2D xform, Model2D scene)
        {
            if (xform == null) xform = new SceneView2D().WithSceneBounds(scene.BoundingBox);
        ...
        public void DrawScene(Size? viewport, ISceneViewport3D xform, Model3D scene)
        {
            if (xform == null) xform = new SceneView3D().WithSceneBounds(scene.BoundingBox);
        ...
        public void DrawScene(System.Windows.Media.DrawingContext dc, Size? viewport, ISceneViewport2D xform, Model2D scene)
        {
            this.VerifyAccess();
            SetContext(dc);
        ...
        public void DrawScene(System.Windows.Media.DrawingContext dc, Size? viewport, ISceneViewport3D xform, Model3D scene)
        {
            this.VerifyAccess();
            SetContext(dc);
            DrawScene(viewport, xform, scene);
        ...
        public void DrawScene(System.Windows.Media.DrawingVisual target, Size? viewport, ISceneViewport2D xform, Model2D scene)
        {
            if (!this.CheckAccess())
            {
        ...
        public void DrawScene(System.Windows.Media.DrawingVisual target, Size? viewport, ISceneViewport3D xform, Model3D scene)
        {
            if (!this.CheckAccess())
            {
                this.Dispatcher.Invoke(() => DrawScene(target, viewport, xform, scene));
        ...
        public void DrawScene(System.Windows.Media.Imaging.RenderTargetBitmap target, Size? viewport, ISceneViewport2D xform, Model2D scene)
        {
            if (!this.CheckAccess())
            {
                this.Dispatcher.Invoke(() => DrawScene(target, viewport, xform, scene));
        ...
        public void DrawScene(System.Windows.Media.Imaging.RenderTargetBitmap target, Size? viewport, ISceneViewport3D xform, Model3D scene)
        {
            if (!this.CheckAccess())
            {
                this.Dispatcher.Invoke(() => DrawScene(target, viewport, xform, scene));
        ...
        public static void SaveToBitmap(string filePath, int width, int height, SceneView2D view, Model2D scene)
        {
            var rt = new System.Windows.Media.Imaging.RenderTargetBitmap(width, height,96,96, System.Windows.Media.PixelFormats.Default);

            Default.DrawScene(rt, new Size(width, height), view, scene);

            SaveToPNG(rt, filePath);
        }

        public static void SaveToBitmap(string filePath, int width, int height, SceneView3D view, Model3D scene)
        {
            var rt = new System.Windows.Media.Imaging.RenderTargetBitmap(width, height, 96, 96, System.Windows.Media.PixelFormats.Default);
        ...
        private static void SaveToPNG(System.Windows.Media.Imaging.RenderTargetBitmap rt, string filePath)
        {
        ...
        private static void WritePNG(System.Windows.Media.Imaging.RenderTargetBitmap rt, System.IO.Stream writer)
        {
        ...
        private static void WriteJPEG(System.Windows.Media.Imaging.RenderTargetBitmap rt, System.IO.Stream writer)
        {
            // Save the image to a location on the disk.
