...
namespace InteropTypes.Graphics.Drawing
{
    ...
    /// </summary>
    /// <remarks>
    /// Optionally implemented by <see cref="IScene3D"/> classes.
    /// </remarks>
    public interface ITransformer3D
    {
        /// <summary>
        /// Transforms the given points from virtual space to screen space.
        /// </summary>
        /// <param name="points"></param>
        void TransformForward(Span<Point3> points);

        /// <summary>
        /// Transforms the given vectors from virtual space to screen space.
        /// </summary>
        /// <param name="vectors"></param>
        void TransformNormalsForward(Span<Point3> vectors);
        ...
        /// </summary>
        /// <param name="points"></param>
        void TransformInverse(Span<Point3> points);

        /// <summary>
        /// Transforms the given vectors from screen space to virtual space.
        /// </summary>
        /// <param name="vectors"></param>
        void TransformNormalsInverse(Span<Point3> vectors);
