...
namespace InteropTypes.Tensors
{
    ...
    {
        internal unsafe AsciiImage DebugBitmap
        {
            get
            {
                if (sizeof(T) == 3)
                {
                    ...
                    return AsciiImage.Create(14, span, p => p.Gray, this.Dimensions[1], this.Dimensions[1], this.Dimensions[1]);
                }

                if (typeof(T) == typeof(byte))
                {
                    var span = System.Runtime.InteropServices.MemoryMarshal.Cast<T, byte>(this.Span);
                    return AsciiImage.Create(14, span, p => p, this.Dimensions[1], this.Dimensions[1], this.Dimensions[1]);
                }
                ...
                if (typeof(T) == typeof(float))
                {
                    ...
                    return AsciiImage.Create(14, span, grayEval, this.Dimensions[1], this.Dimensions[1], this.Dimensions[1]);
                }
