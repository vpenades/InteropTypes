...
namespace InteropDrawing.Backends.Collections
{
        ...
        where T : struct
    {
        ...
        {
            int size = _CapacityHelpers.GetCapacity(capacity);
        ...
        private void _Grow()
        {
            int newCount = _CapacityHelpers.ExpandCapacity(_Count);
    ...
    static class _CapacityHelpers
    {
        public static int GetCapacity(int count)
        {
            return (count + 1) * 5 / 3; // 1.66666
        }

        public static int ExpandCapacity(int count)
        {
            return (count + 1) * 5 / 3; // 1.66666
        }
    }
